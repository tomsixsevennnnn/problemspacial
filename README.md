...
> **หมายเหตุ**: Action ด้านบนกำหนด role แค่ตอน**สร้างบัญชีใหม่ครั้งแรก**เท่านั้น หลังจากนั้น role จริงถูกเก็บในฐานข้อมูลของแอปเอง และไม่ถูก sync ทับจาก claim อีก — ถ้าต้องการเปลี่ยน role ของ user ที่มีอยู่แล้ว ต้องแก้ที่ฐานข้อมูลโดยตรง (ไม่มีหน้าจัดการในแอป)
